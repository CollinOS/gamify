...
const HomeTimeline = () => {
  return (
    <div className="flex flex-col justify-center items-start w-full max-w-2xl border-purple-800 mx-auto pt-16 pb-16">
      <div className="absolute m-auto z-10 h-[600px] left-0 right-0 w-4 bg-gradient-to-t from-red-500 via-red-500 to-primary" />
      ...
      <div className="flex flex-row justify-end py-16 w-full">
        <div className="w-60">
          <p>Then: You will relocate to your working environment. </p>
        </div>
      </div>
